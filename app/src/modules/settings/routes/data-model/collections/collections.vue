			...
			return translate(
				sortBy(
					collectionsStore.collections.filter(
						(collection) => collection.collection.startsWith('brio_') === false && collection.meta
					),
		...
		const tableCollections = computed(() => {
			return translate(
				sortBy(
					collectionsStore.collections.filter(
						(collection) =>
							collection.collection.startsWith('brio_') === false &&
			...
			return translate(
				sortBy(
					collectionsStore.collections
						.filter((collection) => collection.collection.startsWith('brio_') === true)
