		...
		<div class="container" :class="{ wide }">
			<div class="title-box">
				...
				<div v-else class="logo" :style="{ backgroundColor: info?.project?.project_color }">
					<img src="./logo-light.svg" alt="Brio" class="brio-logo" />
				</div>
				<div class="title">
...
const colors = computed(() => {
	...
	/**
	 * The default light mode secondary color is based on the standard difference between Brio purple and pink, which is:
