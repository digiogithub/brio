/**
 * @NOTE
 * For all possible keys, see: https://docs.brio.io/self-hosted/config-options/
 */
...
const defaults: Record<string, any> = {
	...
	REFRESH_TOKEN_COOKIE_NAME: 'brio_refresh_token',
...
function processValues(env: Record<string, any>) {
	...
	for (let [key, value] of Object.entries(env)) {
		...
		// (see https://docs.brio.io/reference/environment-variables/#environment-syntax-prefix)
