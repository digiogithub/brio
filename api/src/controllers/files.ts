...
router.use(useCollection('brio_files'));
...
export const multipartHandler: RequestHandler = (req, res, next) => {
	 ...
	 * the row in brio_files async during the upload of the actual file.
	 */
...
const readHandler = asyncHandler(async (req, res, next) => {
	...
	const meta = await metaService.getMetaForQuery('brio_files', req.sanitizedQuery);
