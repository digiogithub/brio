...
import type { BrioTokenPayload } from '../../src/types/index.js';
import { verifyAccessJWT, verifyJWT } from '../../src/utils/jwt.js';

const payload: BrioTokenPayload = { role: null, app_access: false, admin_access: false };
const secret = 'test-secret';
const options = { issuer: 'brio' };
...
const RequiredEntries: Array<keyof BrioTokenPayload> = ['role', 'app_access', 'admin_access'];
