import type { Relation, SchemaOverview } from '@brio/types';
...
/**
 * Converts a Brio field list path to the correct SQL names based on the constructed alias map.
 * For example: ['author', 'role', 'name'] -> 'ljnsv.name'
 * Also returns the target collection of the column: 'brio_roles'
