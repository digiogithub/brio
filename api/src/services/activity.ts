      ...
      for (const mention of mentions) {
        ...
        try {
          ...
          for (const mention of mentions) {
            ...
            // Escape mention for safe use in RegExp constructor
            const escapedMention = mention.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
            comment = comment.replace(new RegExp(escapedMention, 'gm'), userPreviews[uuid] ?? '@Unknown User');
          }
