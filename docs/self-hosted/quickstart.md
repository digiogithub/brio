---
description:
  If you're looking for the fastest way to get up-and-running with Brio, this guide will walk you through getting
...
With the server running, you're now able to login to your new Brio project and start using it.

Our start command stated that the server started at port `8055`, which means we can navigate to `http://localhost:8055`
to open Brio in the browser.
...
![Brio Empty State](https://cdn.brio.io/docs/v9/getting-started/quickstart/quickstart-20220217A/empty-state-20220217A.webp)
...
<source src="https://cdn.brio.io/docs/v9/getting-started/quickstart/quickstart-20220217A/add-field-20220217A.mp4" type="video/mp4" />
</video>

We'll be calling our Field `title`. While Brio offers a range of powerful field customization options, we'll be
...
![Brio Create Item](https://cdn.brio.io/docs/v9/getting-started/quickstart/quickstart-20220217A/create-item-20220217A.webp)
...
By default, all content entered into Brio is considered private. This means that no data will be returned by the
...
Brio ships with a special **"Public"** role that controls what data is returned to non-authenticated users. Select
...
![Brio Permissions](https://cdn.brio.io/docs/v9/getting-started/quickstart/quickstart-20220217A/permissions-20220217A.webp)
