---
description:
  A collection of example Brio configurations for integrating with various OAuth 2.0, OpenID and SAML platforms.
readTime: 2 min read
---

# SSO Examples

Below is a collection of example Brio configurations for integrating with various OAuth 2.0 and OpenID platforms.
...
If the authenticating user has not marked their email as "public" in GitHub, it will not be accessible by Brio.
...
Application ACS URL - `https://your-brio-instance/auth/login/awssso/acs`
