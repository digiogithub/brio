---
description: REST and GraphQL API documentation to access and manage Items in Brio.
readTime: 5 min read
...
Brio. For the sake of documentation, we'll use a fictional articles collection with the following fields: `id`,
...
List all items that exist in Brio.
...
Get an item that exists in Brio.
