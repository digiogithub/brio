---
description: An introduction to the REST and GraphQL APIs in Brio.
readTime: 7 min read
...
> Brio offers both a REST and GraphQL API to manage the data in the database. The API has predictable
...
Brio only retrieves the fields in your items that explicitly have been requested. Relational data can be retrieved
...
this item. To update an existing item, simply provide the primary key with the updates, and Brio will treat it as an
...
[we'd love to hear your thoughts](https://github.com/nicobrio/brio/discussions/new).
...
Below are the global error codes used within Brio, and what they mean.
