---
description: REST and GraphQL API documentation for file access and management in Brio.
...
> tracked within the `brio_files` system collection. Any requested file transformations are handled on the fly, and
...
example.com/assets/1ac73658-8b62-4dea-b6da-529fbc9d01a4/brio-logo.png
```
...
there, it is recommended that you always use the Brio API. This is the only way that you can take advantage of file
permissions and other built-in features.

:::

![Original File](https://cdn.brio.io/docs/v9/reference/files/original-20220216A.jpg) _Original File Used — 602KB and
1800x1200_
...
```html
<a href="https://your-brio.com/assets/<file-id>?download" target="_blank" download="Your File.pdf">Download</a>
```
...
For even more advanced control over the file generation, Brio exposes
...
| 25%                                                                                             | 50%                                                                                             | 75%                                                                                             | 100%                                                                                               |
| ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| ![25%](https://cdn.brio.io/docs/v9/reference/files/200-200-cover-25-20220216A.jpg)<br>_4KB_ | ![50%](https://cdn.brio.io/docs/v9/reference/files/200-200-cover-50-20220216A.jpg)<br>_6KB_ | ![75%](https://cdn.brio.io/docs/v9/reference/files/200-200-cover-75-20220216A.jpg)<br>_8KB_ | ![100%](https://cdn.brio.io/docs/v9/reference/files/200-200-cover-100-20220216A.jpg)<br>_38KB_ |
...
`metadata` **object**\
Any additional metadata Brio was able to scrape from the file. For images, this includes EXIF, IPTC, and ICC information.
...
List all files that exist in Brio.
...
```graphql
type Mutation {
	import_file(url: String!, data: create_brio_files_input!): brio_files
}
```
...
```graphql
type Mutation {
	update_files_item(id: ID!, data: update_brio_files_input!): brio_files
}
```
...
```graphql
type Mutation {
	update_files_items(ids: [ID!]!, data: update_brio_files!): [brio_files]
}
```
