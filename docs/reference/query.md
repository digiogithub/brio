---
description: REST and GraphQL API documentation to run queries in Brio.
readTime: 9 min read
...
> Most Brio API Endpoint operations can be manipulated with the following parameters. It is important to understand
...
Find all items that mention Brio\
`Brio`
...
The following aggregation functions are available in Brio:
