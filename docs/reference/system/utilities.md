---
description: REST and GraphQL API documentation on the Utilities collection in Brio.
readTime: 3 min read
...
Resets both the data and schema cache of Brio. This endpoint is only available to admin users.
