---
description: REST and GraphQL API documentation on the Schema endpoint in Brio.
readTime: 5 min read
...
This endpoint does not allow different Brio versions and database vendors by default. This is to avoid any
