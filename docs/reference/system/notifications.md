---
description: REST and GraphQL API documentation on the Notifications collection in Brio.
readTime: 5 min read
...
List all notifications that exist in Brio.
