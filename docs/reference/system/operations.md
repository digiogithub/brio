...
```graphql
type Query {
	operations_by_id(id: ID!): brio_operations
}
```
...
```graphql
type Mutation {
	create_operations_item(data: create_brio_operations_input!): brio_operations
}
```
...
```graphql
type Mutation {
	create_operations_items(data: [create_brio_operations_input!]!): [brio_operations]
}
```
...
```graphql
type Mutation {
	update_operations_item(id: ID!, data: update_brio_operations_input): brio_operations
}
```
...
```graphql
type Mutation {
	update_operations_items(ids: [ID!]!, data: update_brio_operations_input): [brio_operations]
}
```
