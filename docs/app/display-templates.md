---
description:
  Display Templates, a utility used throughout Brio, allow you to set Field Values and custom text in order to
...
<video title="Set Display Template" autoplay playsinline muted loop controls>
	<source src="https://cdn.brio.io/docs/v9/app-guide/display-templates/display-templates-20220523A/set-display-templates-20220523A.mp4" type="video/mp4" />
</video>
