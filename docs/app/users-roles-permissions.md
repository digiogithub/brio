...
![Users, Roles and Permissions](https://cdn.brio.io/docs/v9/configuration/users-roles-permissions/users-roles-permissions-20220909/users-roles-permissions-20220907A.webp)
...
In order to understand how users, roles, and permissions work in Brio, a conceptual understanding of _how they work
...
[How it Works in Brio](#how-it-works-in-brio).
...
## How it Works in Brio

<video title="How Users, Roles, & Permissions Work" autoplay playsinline muted loop controls>
	<source src="https://cdn.brio.io/docs/v9/configuration/users-roles-permissions/users-roles-permissions-20220909/how-users-roles-and-permissions-work-20220909A.mp4" type="video/mp4" />
</video>

While you have full reign to configure these using SQL, Brio also provides a complete system to configure and manage
...
Remember, the following users, role and permissions systems built into Brio cannot be deleted, however using them is
...
![Users in the Brio Data Studio](https://cdn.brio.io/docs/v9/configuration/users-roles-permissions/users-roles-permissions-20220909/users-20220807A.webp)
...
![Roles in the Brio Data Studio](https://cdn.brio.io/docs/v9/configuration/users-roles-permissions/users-roles-permissions-20220909/roles-20220907A.webp)

You can create as many roles as you need for your project. Brio also comes with built-in administrator and public
...
![Roles in the Brio Data Studio](https://cdn.brio.io/docs/v9/configuration/users-roles-permissions/users-roles-permissions-20220909/permissions-20220907A.webp)

Brio offers an extremely granular, yet easy to configure permissions system. When you
[create a role](#create-a-role), all permissions are turned off by default, allowing you to explicitly grant permissions
as desired.

There are two other key points to note about Brio. First, the term
...
permissions, Brio provides CRUDS permissions: _create, read, update, delete, and share_. This _fifth_ type of
...
![Workflows in the Brio](https://cdn.brio.io/docs/v9/configuration/users-roles-permissions/workflows-20220909/workflows-20220909B.webp)
...
as well as [flows](/configuration/flows.md). Brio supports endlessly configurable workflows.
