...
<video title="Activity Log Overview" autoplay playsinline muted loop controls>
	<source src="https://cdn.brio.io/docs/v9/configuration/activity-log/activity-log-20220816/activity-log-20220816A.mp4" type="video/mp4" />
</video>

The Activity Log is the only Module in Brio Core that is not found in the [Module Bar](/app/overview#_1-module-bar).
...
![Activity Log Default Fields](https://cdn.brio.io/docs/v9/configuration/activity-log/activity-log-20220816/activity-log-default-fields-20220816A.webp)
...
<video title="Filter by Activity" autoplay playsinline muted loop controls>
	<source src="https://cdn.brio.io/docs/v9/configuration/activity-log/activity-log-20220816/filter-by-activity-20220817A.mp4" type="video/mp4" />
</video>
...
<video title="Filter by Activity" autoplay playsinline muted loop controls>
	<source src="https://cdn.brio.io/docs/v9/configuration/activity-log/activity-log-20220816/modify-an-activity-20220817A.mp4" type="video/mp4" />
</video>
...
not begin with `brio_`). To view or modify an activity, follow these steps.
