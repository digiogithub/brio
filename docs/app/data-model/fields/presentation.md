...
![A horizontal divider between two form fields](https://cdn.brio.io/docs/v9/configuration/data-model/fields/interfaces-20230308/interface-divider.webp)
...
![A group of two buttons. One primary button. One default button.](https://cdn.brio.io/docs/v9/configuration/data-model/fields/interfaces-20230308/interface-buttonlinks.webp)

![A form for creating new Button Links. Form has four fields: "Label", "Icon", "Type", "URL"](https://cdn.brio.io/docs/v9/configuration/data-model/fields/interfaces-20230308/interface-buttonlinks-new.webp)
...
![A standard warning notice in yellow with a hazard icon.](https://cdn.brio.io/docs/v9/configuration/data-model/fields/interfaces-20230308/interface-notice.webp)
