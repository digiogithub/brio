...
![Form text input. Value is "value to hash on save"](https://cdn.brio.io/docs/v9/configuration/data-model/fields/interfaces-20230308/interface-hash.webp)

![Form text input that shows the value is securely hashed.](https://cdn.brio.io/docs/v9/configuration/data-model/fields/interfaces-20230308/interface-hash-secure.webp)

Text input that allows users to hash the value on save. Both the API and SDK provide methods to
[verify the hash](https://docs.brio.io/reference/system/utilities.html#verify-a-hash).
...
![A standard form text input](https://cdn.brio.io/docs/v9/configuration/data-model/fields/interfaces-20230308/interface-slider.webp)
