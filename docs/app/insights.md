---
description: Insights is a Module in Brio that allows rapid, no-code build-out of analytics dashboards.
readTime: 9 min read
---

# Insights

> Insights is a Module in Brio that allows rapid, no-code build-out of analytics dashboards. Regardless of your
...
<source src="https://cdn.brio.io/docs/v9/app-guide/insights/insights-20220216A/insights-dashboards-20220216A.mp4" type="video/mp4" />
</video>

## How it Works

<video autoplay playsinline muted loop controls>
<source src="https://cdn.brio.io/docs/v9/app-guide/insights/insights-20220216A/insights-how-it-works-20220216A_1.mp4" type="video/mp4" />
</video>
...
![Dashboard Grid Area](https://cdn.brio.io/docs/v9/app-guide/insights/insights-20220216A/dashboards-overview-20220216A.webp)

Each Brio Dashboard provides a drag-and-drop canvas where you can create and arrange different Panels to easily
...
![How to Add, Edit and Delete Dashboards in Brio Insights](https://cdn.brio.io/docs/v9/app-guide/insights/insights-20220216A/create-edit-delete-dashboards-20220216A.webp)
...
![Brio Dashboard Panels](https://cdn.brio.io/docs/v9/app-guide/insights/insights-20220216A/panels-overview-20220216A.webp)
...
![Panel Header Options](https://cdn.brio.io/docs/v9/app-guide/insights/insights-20220216A/panel-header-options-20220216A.webp)
...
![Label Panel Options](https://cdn.brio.io/docs/v9/app-guide/insights/insights-20220216A/label-panel-options-20220216A.webp)
...
![List Panel Options](https://cdn.brio.io/docs/v9/app-guide/insights/insights-20220216A/list-panel-options-20220216A.webp)
...
![Metrics Panel Options](https://cdn.brio.io/docs/v9/app-guide/insights/insights-20220216A/metric-panel-options-20220216A.webp)
...
![Time Series Panel Options](https://cdn.brio.io/docs/v9/app-guide/insights/insights-20220216A/time-series-panel-options-20220216A.webp)
...
![Global Variables](https://cdn.brio.io/docs/v9/app-guide/insights/insights-220624A/global-variable-220624A.webp)
...
![Dashboard edit page with a bar chart options panel visible.](https://cdn.brio.io/docs/v9/app-guide/insights/20220223/panels-bar-options-230223A.webp)

:::info Availability

The Bar Chart Panel is only available in Brio Cloud and Enterprise Self-Hosted projects.
...
![Dashboard edit page with a line chart options panel visible.](https://cdn.brio.io/docs/v9/app-guide/insights/20220223/panels-line-options-230223A.webp)

:::info Availability

The Line Chart Panel is only available in Brio Cloud and Enterprise Self-Hosted projects.
...
![Dashboard edit page with a meter options panel visible.](https://cdn.brio.io/docs/v9/app-guide/insights/20220223/panels-meter-options-230223A.webp)

:::info Availability

The Meter Panel is only available in Brio Cloud and Enterprise Self-Hosted projects.
...
![Dashboard edit page with a pie or donut options panel visible.](https://cdn.brio.io/docs/v9/app-guide/insights/20220223/panels-pie-donut-options-230223A.webp)

:::info Availability

The Pie and Donut Chart Panels are only available in Brio Cloud and Enterprise Self-Hosted projects.
