...
> The Brio data studio enables no-code configuration and management for any SQL database, with no arbitrary
...
Remember, you will have full access to manage your database using SQL. Brio will mirror any changes. You can also
...
In order to understand how Brio handles data models, you will need an understanding of what relational data models
...
and schemas then feel free to jump to [Data Models in Brio](#data-models-in-brio).

### Databases

Brio is an SQL database wrapper. A database is a set of data stored in a computer, in a structured way, making it
organized, accessible, and scalable. The specific way you structure your data within a database is called your data
model.

![A Database Schema](https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/database-schema-20220805A.webp)
...
![Data in an Excel Spreadsheet](https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/spreadsheet-20220805A.webp)
...
![A data table](https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/datatable-20220805A.webp)
...
![A Data Table: rows and columns](https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/rows-and-columns.webp)
...
![A Column](https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/columns-20220805A.webp)
...
![Cell Values](https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/datatable-cell-value-20220805A.webp)
...
![Rows](https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/row-20220805A.webp)
...
![Primary Key](https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/primary-keys-20220805A.webp)
...
![Foreign Keys](https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/foreign-keys-20220805A.webp)
...
To learn more about how these relationships work conceptually, as well as how they are handled within Brio, see our
guide on [relationships](/configuration/data-model/relationships).

### Database Schemas

![Data Table to schema](https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/datatable-to-schema-20220805A.webp)
...
![A Complex Schema](https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/complex-schema.webp)
...
![Duplicate Data](https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/duplicate-data-20220829A.webp)
...
![Database, Backend, Frontend](https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/database-backend-frontend-20220805A.webp)
...
<video title="Settings > Data Model" autoplay playsinline muted loop controls>
	<source src="https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/data-model-overview-20220805A.mp4" type="video/mp4" />
</video>

All relational data model concepts listed above apply in Brio. You get complete, un-opinionated, relational data
model design and configuration. The difference is that Brio handles all SQL, builds the API, and provides a Data
...
Brio replaces traditional relational database jargon with more user-friendly terms and concepts. Please keep in mind
that while traditional relational database jargon strictly encompasses database concepts, some of the new Brio terms
encompass these relational database concepts _plus display and interaction logic_. The following sections will introduce
Brio terms and map them to classic relational database concepts.

## Collections

<video title="Collections" autoplay playsinline muted loop controls>
	<source src="https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/collections-20220805A.mp4" type="video/mp4" />
</video>
...
<video title="Fields" autoplay playsinline muted loop controls>
	<source src="https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/fields-20220805A.mp4" type="video/mp4" />
</video>
...
how this data is displayed and interacted with. In Brio, fields encompass column configurations, as well as custom
configuration over how to the data is displayed and interacted with in the Data Studio. Brio also has
...
<video title="Collections" autoplay playsinline muted loop controls>
	<source src="https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/items-20220805A.mp4" type="video/mp4" />
</video>
...
Brio abstracts type differences between SQL vendors with a
...
<video title="Keys and IDs" autoplay playsinline muted loop controls>
	<source src="https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/keys-and-ids-20220805A.mp4" type="video/mp4" />
</video>

Primary keys are called IDs in Brio fairly frequently. When you
[create a collection](/configuration/data-model/collections#create-a-collection), you must add an `id` field. Brio
...
<video title="Relations" autoplay playsinline muted loop controls>
	<source src="https://cdn.brio.io/docs/v9/configuration/data-model/data-model-20220805/relationships-20220805A.mp4" type="video/mp4" />
</video>

Brio supports all standard [types of relationships](#types-of-relationships), as well as a few more of its own
