---
description: A guide on how to build custom Panels in Brio.
readTime: 3 min read
---
...
The panel component is the part of your extension that will be rendered by the Brio App whenever your panel should
