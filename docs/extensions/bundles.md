---
description: A guide on how to build extension bundles in Brio.
readTime: 5 min read
---
...
When [scaffolding your Brio extension](/extensions/creating-extensions.html#scaffolding-your-brio-extension),
select the `bundle` type. This will create a new empty bundle.

## Entries

In your bundle's `package.json` file, the `brio:extension` object has an `entries` array that describes all of the
