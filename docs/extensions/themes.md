---
description: A guide on how to build custom Themes in Brio.
readTime: 2 min read
---

# Themes & Styling

> **Form Follows Function** is the guiding design principle of Brio. The minimal UI allows the platform to be easily
> tailored to your brand. [Learn more about the App](/app/overview).

## App Themes

The Brio App has been developed with customization and extensibility in mind. Colors and styles referenced within
...
- **Themes** — See the [Light Theme](https://github.com/nicobrio/brio/blob/main/app/src/styles/themes/_light.scss)
  or [Dark Theme](https://github.com/nicobrio/brio/blob/main/app/src/styles/themes/_dark.scss)
- **Typography** — See the [Fonts](https://github.com/nicobrio/brio/blob/main/app/src/styles/_type-styles.scss) and
  [Type Styles](https://github.com/nicobrio/brio/blob/main/app/src/styles/mixins/type-styles.scss)
- **Variables** — See the
  [Global Variables](https://github.com/nicobrio/brio/blob/main/app/src/styles/_variables.scss)
...
"Brio Purple". While it may be tempting to override this variable with your brand's color, please first review the
following warnings:
