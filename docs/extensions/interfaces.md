---
description: A guide on how to build custom Interfaces in Brio.
readTime: 4 min read
---
...
The interface component is the part of your extension that will be rendered by the Brio App whenever your interface
...
component, it should be emitted to the Brio App by using the `input` emit.
...
Other than this simple API to communicate with the Brio App, the interface component is a blank canvas, allowing you
