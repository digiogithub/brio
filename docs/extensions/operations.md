...
loading your operation, this object is imported by the Brio App host.
...
your operation, this object is imported by the Brio API host.
...
The extension id needs to be identical for both entrypoints in order for Brio to recognize them as part of the same
extension.
