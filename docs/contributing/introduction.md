---
description: An introduction to the process, rules and guidelines that for all code contributions to Brio.
readTime: 6 min read
---

# Contributing

Heya! Welcome to Brio, and thank you for taking the time to contribute back to our project! ❤️ We want everybody to
be able to contribute to Brio, no matter your background or expertise. In order to facilitate that, we've put
...
> [our Discord server](https://discord.gg/brio).

## Code of Conduct

**The Brio [Code of Conduct](https://github.com/nicobrio/brio/blob/main/code_of_conduct.md) is one of the ways
...
[Code of Conduct](https://github.com/nicobrio/brio/blob/main/code_of_conduct.md).**
...
https://github.com/nicobrio/brio/issues
...
Discussion on our GitHub Discussions board: https://github.com/nicobrio/brio/discussions

### Helping Others

The Brio community is growing quickly, which also means there's more and more people that have questions. Helping
out your fellow developers by answering questions on [Discord](https://discord.gg/brio) or
[GitHub Discussions](https://github.com/nicobrio/brio/discussions/categories/q-a) is a great way to help the
project.
...
[the core team](https://github.com/orgs/nicobrio/people)'s discretion first. This is often due to a lack of detail, or
lack of proven interest.

Each Pull Request that comes in is required to resolve [an open Issue](https://github.com/nicobrio/brio/issues) that
...
[GitHub Security Advisory](https://github.com/nicobrio/brio/security/advisories) for tracking the fix.
