---
description:
  This guide explains how to publish a forked version of Brio on NPM, Dockerhub and GHCR. You need to first create a
  fork.
readTime: 2 min read
---
...
> This guide explains how to publish a forked version of Brio on NPM, Dockerhub and GHCR. You need to first
...
| ----------------- | ---------------------------------------------------------------------- | --------------------------- |
| `GHCR_IMAGE`      | Image name for GitHub Container Registry. Be sure to use the full URL. | `ghcr.io/nicobrio/brio` |
| `DOCKERHUB_IMAGE` | Image name for hub.docker.com, no prefix.                              | `nicobrio/brio`         |

| Secret               | Description                                             | Example        |
| -------------------- | ------------------------------------------------------- | -------------- |
| `NPM_TOKEN`          | Your NPM token. Make sure to use the type "automation". | `12345678-...` |
| `DOCKERHUB_USERNAME` | Dockerhub Username                                      | `brio`     |
