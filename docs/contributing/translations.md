---
description:
  Brio supports internationalization across the entire App. Many languages are currently supported, with more being
...
Our [Crowdin](https://locales.brio.io) page provides an external interface for managing all of the different
...
1. Navigate to [Crowdin](https://locales.brio.io)
...
to a Core Team member via [Discord](https://discord.gg/brio).
