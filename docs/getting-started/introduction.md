---
description: An introduction to what Brio is, how it works, who it is for, and when to use it.
readTime: 8 min read
---

# Introduction

> These Docs will help you get Brio up-and-running quickly, guide you through advanced features, and explain the
> core concepts that make Brio so unique.

## What is Brio?

::: tip Brio

Brio ([duh REKT iss](http://audio.pronouncekiwi.com/Salli/Brio)) is Latin for: _laid straight, arranged in
lines_.\
...
**Brio is an Open Data Platform built to democratize the database.**\
This platform provides everyone on your team, _regardless of technical skill_, equal access to data and digital file asset
management, for any data model or project. First, link Brio to your desired SQL database and file storage adapter. After
that, Brio enables you to perform CRUD operations, create users, assign roles with fully configurable permissions, build
...
SQL flavors all come with slightly different data types and idiosyncrasies. Brio uses [Database Introspection](#how-it-works)
to read your database structure and create an abstraction layer to handle all the nitty-gritty details behind the scenes.
This technique works seamlessly with any major SQL database. It also lets you link Brio to your new or pre-existing database
or remove it anytime, with no impact on your existing data model. That means you'll never encounter vendor lock-in.

**The App and APIs**\
Once your database is introspected and abstracted, Brio dynamically generates REST and GraphQL API endpoints to manage
...
This architecture is how Brio democratizes the database and provides control to [the whole team](#who-s-it-for).

**Open-Source, Modular, Extensible, Scalable**\
At the highest level, Brio organizes its features and functionality into Modules. Each Module allows you to interact
with data in some specific way, such as data and content management, digital file asset management, drag and drop analytics
dashboard creation, or whatever. If you find Brio is missing something that your project needs, no problem!

Built entirely in Typescript, primarily on [Node.js](https://nodejs.dev) and [Vue.js](https://vuejs.org), Brio is
...
Get a project running in minutes. Learn Brio hands-on in the [Quickstart Guide](/getting-started/quickstart).

:::

## How It Works

**Brio is installed as a _layer_ on top of your new or existing SQL database.**
...
That is not the case with Brio. Brio gives you direct access to your pure and unaltered data. That means you
have the option to bypass the Brio middleware (API, SDK, App) and connect to your data with proper SQL queries. This
...
**Brio lets the whole team work together and access data in one place.**
...
To keep things simpler, _especially for the no-code users_, Brio uses friendlier names for many database terms and
...
<!--
@TODO getting-started > learn-brio
For more information on Brio-specific terms, see the guide on [how to learn Brio](/getting-started/learn-brio).
-->

:::

<!--
:::tip Ready to see what Brio can do?

Checkout the core features and learn Brio hands-on in the [Quickstart Guide](/getting-started/quickstart).
...
**Brio can power any data-driven project and can be linked or removed at any time.**

Build, monitor or manage any data model or app you desire: IoT fleets, e-commerce, SaaS, business data analytics,
multi-channel content, _or anything else!_ If it involves SQL and digital files, you can link up Brio. With this in
...
webhooks and task automation. Completely detached from the database, you're free to link and remove Brio anytime or use
...
**Brio is a simple, data-first solution to complex problems with no downsides.**

Brio was created in 2004 and has been slowly, iteratively improved on for a long time. The core team has carefully
...
scalability, migration options, etc.. all match the project in question. However, with Brio, that's not the case!
...
- **Open** — Brio Core is open source, with no obfuscated or cloud-only code.
...
**Brio Cloud is the fastest and easiest way to get your Brio Projects going.**

Cloud architecture can be complicated and resource-intensive. Brio Cloud provides scalable, optimized storage and
infrastructure, and automatic updates so developers can focus on the app's core business logic. Brio Cloud also
offers [Cloud Exclusive Extensions](/cloud/glossary#cloud-exclusives), enhancing Brio Core with even more features.

With your free Brio Cloud account, you can set up Teams to organize Projects, Project billing, and other Team
...
:::tip Ready to try Brio Cloud?

Set up your free Cloud account and learn Brio hands-on in the [Quickstart Guide](/getting-started/quickstart).

:::

:::tip Enterprise Cloud

Need advanced configuration, unlimited scalability, and dedicated support? [Contact us](https://brio.io/contact)
