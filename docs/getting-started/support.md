---
description: How to get support for your Brio project.
readTime: 4 min read
---

# Help & Support

> If you have questions while working with Brio, there are many resources to help you get up-and-running smoothly.

## Troubleshooting Steps

If you're experiencing issues or think you have found a problem in Brio, be sure to follow these steps before
...
2. Ensure you’re on the [latest version](https://github.com/nicobrio/brio/releases/latest) of Brio.
3. Stop `CTRL+C` and restart the server `npx brio start`.
4. Run the database migration script: `brio database migrate:latest`\
...
8. Check for [existing Issues](https://github.com/nicobrio/brio/issues?q=is%3Aissue) (and
   [Discussions](https://github.com/nicobrio/brio/discussions)) that match your problem.
...
[GitHub Discussions](https://github.com/nicobrio/brio/discussions) is a great first place to reach out for help. Our
...
Our [Discord Community](https://discord.gg/brio) is another great way to get assistance. Please keep all questions in the
...
While the Brio Core Team plays an active and engaged role in community discussions, there is no guaranteed response
...
Basic and Premium Support offer direct communication with the Brio Core Team. Basic support is included on all
...
us at [support@brio.io](mailto:support@brio.io).

## Sponsored Work

### Commissioned Features

If you need a specific feature added to Brio faster than the normal development timeline,
[reach out to us](https://brio.io/contact) for a quote. Our parent agency will often help subsidize the cost of
...
resolved sooner, [reach out to us](https://brio.io/contact) for a quote.

## Frequently Asked Questions

### Does Brio support Mongo/NoSQL?

Not currently. Brio has been built specifically for wrapping _relational_ databases. While we could force Mongo to
...
Brio is an open-source project, maintained by a small core team and community contributors who have limited time and
resources.

Our platform is feature-rich, however we strictly adhere to our
[80/20 Rule](/contributing/introduction#feature-requests) to avoid a messy/bloated codebase. Brio is also quite
...
[submit a pull request](https://github.com/nicobrio/brio/pulls) — after all, it is open-source!
