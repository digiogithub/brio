---
description:
  Get up and running with Brio Cloud in minutes. Learn the basics of building your data model and managing
  permissions.
readTime: 7 min read
---
...
> This quickstart guide is designed to get you up and running with a Brio Cloud Project in a snap. Along the way,
> you will better understand what Brio is, setup your free Brio Cloud Account, get a _hands-on introduction_ to
...
[Brio Cloud](https://brio.cloud/login)

Your Brio Cloud Account allows you to create and manage any number of Projects. We've made life easier by giving you
...
create. Each Brio Cloud Project exists within the scope of one Team. They allow you to organize Team Members,
Projects and Project Billing as desired.

Once your Team is created, it's time to create your Brio Cloud Project!
...
3. Fill in a Field name under **Key**. We'll be calling our Field `title`.\
   Brio offers powerful Field customization options, but let's stick to the defaults for now.
4. Select **"Save"**.
...
Brio comes with two built-in roles: Public and Admin. The Public Role determines what data is returned to
...
By Default, content entered into Brio will be considered private. So permissions always start off set to the default
...
1. Open `http://your-project-url.brio.app/items/articles`.\
