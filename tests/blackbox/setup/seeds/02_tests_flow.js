...
exports.seed = async function (knex) {
	...
	await knex('brio_roles').where('id', 'd70c0943-5b55-4c5d-a613-f539a27a57f5').del();
	...
	await knex('brio_users').where('id', '3d075128-c073-4f5d-891c-ed2eb2790a1c').del();

	await knex('brio_users').insert([
		{
