...
Heya! Welcome to Brio, and thank you for taking the time to contribute back to Open Source Software! ❤️ We want
everybody to be able to contribute to Brio, no matter your background or expertise. In order to facilitate that,
we've put together a couple tips and tricks below. Our team truly appreciates every single contributor, community
member, GitHub star, pull-request, bug report, and feature request. Keeping Brio completely free and open-source is
our way of saying: **Thank you!**

> We're here to help!
>
> If you have _any_ questions along your contributor journey, please feel free to come chat with us on
> [our Discord server](https://brio.chat).

## Code of Conduct

**The Brio [Code of Conduct](https://github.com/brio/brio/blob/main/code_of_conduct.md) is one of the ways
we put our values into practice. We expect all of our staff, contractors and contributors to know and follow this
code.**

**Our contributors and maintainers work extremely hard to build Brio as premium open-source software. Please be
...
[Code of Conduct](https://github.com/brio/brio/blob/main/code_of_conduct.md).**
...
https://github.com/brio/brio/issues
...
Discussion on our GitHub Discussions board: https://github.com/brio/brio/discussions

### Document the Project

The [Brio Docs](https://github.com/brio/docs) are living documents that can always be improved on. Notice any
parts of the docs in dire need of some tender love and care? Feel free to open a Pull Request!

### Helping Others

The Brio community is growing quickly, which also means there's more and more people that have questions. Helping
out your fellow developers by answering questions on [Discord](https://brio.chat) or
[GitHub Discussions](https://github.com/brio/brio/discussions/categories/q-a) is a great way to help the
project.
...
With the continuous growth of Brio, more and more people are relying on Brio for (critical) data workloads in
various use cases. This means we need to be careful with any changes that might affect the stability, security,
performance, or scalability of Brio. For this reason, it's important that any new feature is properly thought
...
[the core team](https://github.com/orgs/brio/people)'s discretion first. This is often due to a lack of detail, or
lack of proven interest.

Each Pull Request that comes in is required to resolve [an open Issue](https://github.com/brio/brio/issues) that
...
If you believe you have discovered a security issue within a Brio product or service, please reach out to us
directly over email: [security@brio.io](mailto:security@brio.io). We will then open a
[GitHub Security Advisory](https://github.com/brio/brio/security/advisories) for tracking the fix.
...
- They do not publish the vulnerability prior to the Brio team releasing a fix for it
